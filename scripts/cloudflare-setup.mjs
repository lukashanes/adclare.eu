...
const zoneName = process.env.CF_ZONE_NAME || "adclare.eu";
const originIpv4 = process.env.ORIGIN_IPV4 || "46.224.66.79";
...
const turnstileWidgetName = process.env.TURNSTILE_WIDGET_NAME || "Adclare production";
