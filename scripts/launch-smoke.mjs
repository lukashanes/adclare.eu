...
check(workspaceDb.includes("publicWorkflowStatuses"), "Public workflow status allowlist is missing.");
...
check(appWorkspace.includes("Kampaně a tagy") && appWorkspace.includes('type === "campaign"') && workspaceDb.includes("createAppCampaign") && workspaceDb.includes("update_campaign"), "Workspace should expose campaign and tag management.");
